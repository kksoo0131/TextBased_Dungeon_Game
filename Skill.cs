...
namespace TextBased_Dungeon_Game
{
    ...
    public class Skill
    {
        ...
        public Skill(string name, string skillInfo,float skillRate, int mp, int targetCount, SkillType type, string className)
        {
            this.name = name;
            ...
            this.type = type;
            this.classType = Type.GetType($"TextBased_Dungeon_Game.{className}");
        }
        // 스킬 마다 클래스로 생성
